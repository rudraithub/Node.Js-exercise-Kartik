...
let name = "WelCome To Rudra IT Hub"
...
let name1 = "Rudra IT Hub.com";

let text = name1.split('');
console.log(text)
...
let words=word.split(" ").length;

console.log(words)

//0108 - write a program to to convert a string to lowercase.

let stringUPPERCAS= "WELCOME TO RUDRA IT HUB";
let stringLowercas=stringUPPERCAS.toLocaleLowerCase();
console.log(stringLowercas)

//0109 - write a program to replace a specific word or character in a text string with another word or character.

let name2="Rudra";
let newname2=name2.replace("Rudra","It Hub");
